...
<div class="bg-background min-h-screen">
	<header class="bg-background flex h-16 w-full shrink-0 items-center border-b px-4 md:px-6">
		<Sheet>
			...
			<SheetContent side="right">
				...
				<div class="grid gap-2 py-6">
					...
					<a href="/reviews" class="flex w-full items-center py-2 text-lg font-semibold">
						Reviews
					</a>
					...
					<div class="mt-4 flex flex-col gap-2">
						...
						<Button class="w-full">Claim a business</Button>
					</div>
				</div>
			</SheetContent>
		</Sheet>
		...
		<div class="ml-auto flex gap-2">
			<Button variant="outline" class="hidden sm:flex">Login</Button>
			<Button>
				<span class="hidden sm:inline">Claim your Business</span>
