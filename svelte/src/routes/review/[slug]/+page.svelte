<script lang="ts">
	...
	import { CalendarIcon, Dog, ImagePlus, LoaderCircle, MapPin, Star, X } from '@lucide/svelte';
					...
					<Card.Content class="space-y-8 p-6 md:p-8">
						...
						<div class="flex space-x-2">
							...
							<Label for="terms" class="text-sm text-gray-600">
								...
								of this place. I understand that Woofs Welcome has a zero-tolerance policy for fake
								reviews and that my review may be removed if it is found to violate these
								guidelines.
							</Label>
						</div>
